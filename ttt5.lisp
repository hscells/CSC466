...
(defmethod make-heuristic-move ((p heuristic-machine-player) (report t) &aux move)
   (make-move p report)
)
...
(defmethod ddv()
   (demo-hlm-vs-random 25 10 t)
)

(defmethod dds ()
   (demo-hlm-vs-random 100 20 nil)
)

(defmethod ddm ()
   (demo-hlm-vs-random 500 100 nil)
)

(defmethod ddl ()
   (demo-hlm-vs-random 1000 200 nil)
)
